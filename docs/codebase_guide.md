...
*   **Main Application Package** ([src/lan_streamer/](file:///home/sadmin/antigravity/lan-streamer/src/lan_streamer)):
    ...
    *   [src/lan_streamer/db/](file:///home/sadmin/antigravity/lan-streamer/src/lan_streamer/db): Manages local database structure, database models ([models.py](file:///home/sadmin/antigravity/lan-streamer/src/lan_streamer/db/models.py)), queries (e.g., [queries_playback.py](file:///home/sadmin/antigravity/lan-streamer/src/lan_streamer/db/queries_playback.py)), serialization ([orm_serialization.py](file:///home/sadmin/antigravity/lan-streamer/src/lan_streamer/db/orm_serialization.py)), connection setup, and database synchronization.
