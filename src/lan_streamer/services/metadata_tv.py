"""TV-series metadata resolution helpers.

Provides functions for building series / season / episode metadata defaults,
resolving Jellyfin IDs, downloading posters, processing TMDB episode groups,
and matching local video files against TMDB episode lists.
"""
...
logger = logging.getLogger("lan_streamer.services.metadata_tv")
