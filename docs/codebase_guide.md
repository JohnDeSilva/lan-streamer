...
*   **Main Application Package** ([src/lan_streamer/](file:///home/sadmin/antigravity/lan-streamer/src/lan_streamer)):
    ...
    *   [src/lan_streamer/scanner/](file:///home/sadmin/antigravity/lan-streamer/src/lan_streamer/scanner): Logic for scanning filesystem directories, parsing filenames ([parser.py](file:///home/sadmin/antigravity/lan-streamer/src/lan_streamer/scanner/parser.py)), resolving metadata match rankings against providers, and bulk-renaming local media ([renamer.py](file:///home/sadmin/antigravity/lan-streamer/src/lan_streamer/scanner/renamer.py)).
