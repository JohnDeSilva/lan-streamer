...
def test_segmented_progress_bar_ordering(qtbot):
    ...
    tree = {
        "Anime": {"type": "tv", "roots": {"/storage/anime": {}}},
        "tv": {"type": "tv", "roots": {"/storage/tv1": {}, "/storage/tv2": {}}},
    }
    ...
    bar.init_from_tree(
        tree, library_order=library_order, library_config_source=config_source
    )
    ...
    bar.init_from_tree(
        tree, library_order=library_order, library_config_source=config_source_rev
    )
